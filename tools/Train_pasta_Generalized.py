...
from models.train_Generalized_pasta import train_net
from networks.pasta_Generalized import ResNet50
...
if __name__ == '__main__':
    ...
    if cfg.TRAIN_MODULE_CONTINUE == 1:
        ...
        if cfg.TRAIN_INIT_WEIGHT == 1:   # pretrain on full PaStaNet or train on HICO-DET
            ...
            weight    = cfg.ROOT_DIR + '/Weights/pasta_full/HOI_iter_2000000.ckpt'
